...
df.shape
# DF is the df with all the new data
...
df.shape
print(f' the BothTeamBoxes Dataframe is {df.shape[0]} rows and {df.shape[1]} columns')
...
# check missing
missing = missing_games.isnull().sum()
missing[missing > 0]
# Then for team 2
...
def get_salaries(team, trad_season):
    try:
        ...
        return np.nan
missing_games['team_salary'] = missing_games.apply(lambda row: get_salaries(row['trad_team'], row['trad_season']), axis=1)
...
def get_yoy(team, trad_season):
    try:
        ...
        return np.nan
missing_games['team_yoy_salary_change'] = missing_games.apply(lambda row: get_yoy(row['trad_team'], row['trad_season']), axis=1)
missing_games['team2_yoy_salary_change'] = missing_games.apply(lambda row: get_yoy(row['team_2'], row['trad_season']), axis=1)
...
def get_home_minutes(matchup):
    ...
    return home_min
#TEST 
matchup = 'PHX @ TOR_12_30_2022'

get_home_minutes(matchup)
...
# test
get_player_score('Trae Young', 2022)
missing_games.head(3)
...
missing_games['Tm1_Points_Estimate_80gm'] = ((missing_games['tm1_80_game_avg_pace'] + missing_games['tm2_80_game_avg_pace'])/2) * ((missing_games['tm1_80_game_avg_offrtg'] - (missing_games['tm1_80_game_avg_defrtg'] - missing_games['nba_80_gm_avg_defrtg'])))
missing_games['Tm2_Points_Estimate_80gm'] = ((missing_games['tm1_80_game_avg_pace'] + missing_games['tm2_80_game_avg_pace'])/2) * ((missing_games['tm2_80_game_avg_offrtg'] - (missing_games['tm2_80_game_avg_defrtg'] - missing_games['nba_80_gm_avg_defrtg'])))
...
missing_games['Tm1_Points_Estimate_40gm'] = ((missing_games['tm1_40_gm_avg_pace'] + missing_games['tm2_40_gm_avg_pace'])/2) * ((missing_games['tm1_40_gm_avg_offrtg'] - (missing_games['tm1_40_gm_avg_defrtg'] - missing_games['nba_40_gm_avg_defrtg'])))
missing_games['Tm2_Points_Estimate_40gm'] = ((missing_games['tm1_40_gm_avg_pace'] + missing_games['tm2_40_gm_avg_pace'])/2) * ((missing_games['tm2_40_gm_avg_offrtg'] - (missing_games['tm2_40_gm_avg_defrtg'] - missing_games['nba_40_gm_avg_defrtg'])))
...
missing_games['Tm1_Points_Estimate_20gm'] = ((missing_games['tm1_20_gm_avg_pace'] + missing_games['tm2_20_gm_avg_pace'])/2) * ((missing_games['tm1_20_gm_avg_offrtg'] - (missing_games['tm1_20_gm_avg_defrtg'] - missing_games['nba_20_gm_avg_defrtg'])))
missing_games['Tm2_Points_Estimate_20gm'] = ((missing_games['tm1_20_gm_avg_pace'] + missing_games['tm2_20_gm_avg_pace'])/2) * ((missing_games['tm2_20_gm_avg_offrtg'] - (missing_games['tm2_20_gm_avg_defrtg'] - missing_games['nba_20_gm_avg_defrtg'])))
...
missing_games['Tm1_Points_Estimate_10gm'] = ((missing_games['tm1_10_gm_avg_pace'] + missing_games['tm2_10_gm_avg_pace'])/2) * ((missing_games['tm1_10_gm_avg_offrtg'] - (missing_games['tm1_10_gm_avg_defrtg'] - missing_games['nba_10_gm_avg_defrtg'])))
missing_games['Tm2_Points_Estimate_10gm'] = ((missing_games['tm1_10_gm_avg_pace'] + missing_games['tm2_10_gm_avg_pace'])/2) * ((missing_games['tm2_10_gm_avg_offrtg'] - (missing_games['tm2_10_gm_avg_defrtg'] - missing_games['nba_10_gm_avg_defrtg'])))
...
to_drop  = ['Unnamed: 0.4',
 ...
 'date_y',
 'my_gameid']
# drop cols in missing_games
old_df_final.drop(to_drop, axis=1, inplace=True)
